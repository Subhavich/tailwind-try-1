          ...
          >
            <div className=" min-h-96 p-4 text-zinc-50">
              <div className="mx-auto grid max-w-4xl grid-flow-dense grid-cols-12 gap-4">
                ...
                {/* Hero Text */}
                <ModalBlock className="text-center col-span-12 font-semibold md:text-left text-xl text-white md:col-span-8">
              ...
              <h5 className=" text-center w-full font-semibold text-zinc-800 text-xl mt-4 ">
                {subtitle}
              </h5>
              <button
                onClick={() => setModalOpen(false)}
